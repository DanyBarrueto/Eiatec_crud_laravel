                        ...
                        <form action="{{route('example-app.buscar')}}" method="GET">
                            <div class="form-row">
                                ...
                                <div class="col-auto my-1" >
                                    ...
                                    <input type="submit" class="btn btn-info fw-bold" id="boton_limpiar" style="width:27vh" value="Limpiar" formaction="{{ route('example-app.index') }}">
                                </div>                                
                            </div>
                        </form>
                    </div>
                                                ...
                                                <form class="col-md-8" action="{{ route('example-app.update') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <input type="text" id="nombre" name="nombre" class="form-control border-dark  text-white text-center" style="background-color:  #33ccff;" value="{{$item->Nombre}}" pattern="[a-zA-ZáéíóúÁÉÍÓÚüÜ\s]+" title="Por favor, ingrese solo letras" />
                                                        </div>
